...
namespace BIBLIOTECA_APOSTILA.Controllers
{
    public class PessoasController : Controller
    {
        ...
        public async Task<IActionResult> Create([Bind("Id,Nome,DataNascimento")] Pessoas pessoas)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("Id,Nome,DataNascimento")] Pessoas pessoas)
        {
            if (id != pessoas.Id)
            {
                return NotFound();
