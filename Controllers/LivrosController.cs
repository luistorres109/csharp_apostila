...
namespace BIBLIOTECA_APOSTILA.Controllers
{
    public class LivrosController : Controller
    {
        ...
        public async Task<IActionResult> Create([Bind("Capitulos,Paginas,Editora,Categoia,Id,Nome,CodigoAutor,DataPublicacao")] Livros livros)
        {
            ...
            ViewData["CodigoAutor"] = new SelectList(_context.Autores, "Id", "Nome", livros.CodigoAutor);
            return View(livros);
        }
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("Capitulos,Paginas,Editora,Categoia,Id,Nome,CodigoAutor,DataPublicacao")] Livros livros)
        {
            if (id != livros.Id)
            {
                return NotFound();
